...
exports.deleteCredential = exports.getCredentialsByUserId = exports.getCredentialById = exports.createCredential = void 0;
...
function getCredentialById(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const credential = yield credentialService.getCredentialById(id, userId);
        res.status(200).send(credential);
    });
}
exports.getCredentialById = getCredentialById;
function getCredentialsByUserId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id: userId } = res.locals.id;
        const credentials = yield credentialService.getCredentialsByUserId(userId);
